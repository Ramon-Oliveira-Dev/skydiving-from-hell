          ...
          <div className="mb-12 sm:mb-16 md:mb-24 text-center flex flex-col items-center justify-center">
            <div className="mb-2 sm:mb-3">
              <TypewriterTitle
                ...
                sequences={[
                  { text: "CONEXÃO & REDES SOCIAIS", deleteAfter: true, pauseAfter: 3500 },
                  { text: "CONTRATAÇÃO DE SHOWS", deleteAfter: true, pauseAfter: 2500 },
                  { text: "ASSESSORIA & IMPRENSA", deleteAfter: true, pauseAfter: 2500 },
                  { text: "CONTATO DIRETO S.D.F.H.", deleteAfter: true, pauseAfter: 2500 },
                ]}
                typingSpeed={38}
                deleteSpeed={18}
                autoLoop={true}
            ...
            <h2 className="linha-mask text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight pb-2 leading-tight overflow-visible flex items-center justify-center">
              <TypewriterTitle
                sequences={[
                  { text: "Booking & Contato", deleteAfter: true, pauseAfter: 4000 },
                  { text: "Leve o S.D.F.H. à sua Cidade", deleteAfter: true, pauseAfter: 2800 },
                  { text: "Fale no WhatsApp", deleteAfter: true, pauseAfter: 2800 },
                  { text: "Envie um E-mail Direto", deleteAfter: true, pauseAfter: 2800 },
                ]}
                typingSpeed={42}
                deleteSpeed={20}
                autoLoop={true}
